...
//     if (hotel && room) {
//       axios
//         .patch(`/api/room/${room._id}`, values, { withCredentials: true })
//         .then((res) => {
//           alert("ROOM UPDATED!!");
//           router.refresh();
//           setIsLoading(false);
...
//       if(!hotel) return;
//       axios
//         .post("/api/room", {...values, hotelId : hotel?._id}, { withCredentials: true })
//         .then((res) => {
//           alert("room created");
//           router.refresh();
//           setIsLoading(false);
...
import { Button } from "../ui/button";
import axios from "axios";
import { Circle, Loader2, Pencil, PencilLine, XCircle } from "lucide-react";
import { UploadButton } from "../uploadthing";
import { useRouter } from "next/navigation";
...
const formSchema = z.object({
  ...
  bedCount: z.coerce
    .number()
    .min(1, { message: "Bed Count is Required" }),
  guestCount: z.coerce
    .number()
    ...
    if (hotel && room) {
      ...
      axios
        ...
        .then((res) => {
          ...
          setIsLoading(false);
          handleDialogueOpen();
          // Redirect to the hotel page instead of just refreshing
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Breakfast Price in Naira</FormLabel>
                    <FormDescription>
                      Optional breakfast price per person
                    </FormDescription>
                    <FormControl>
                      <Input type="number" min={0} {...field} />
                    </FormControl>
